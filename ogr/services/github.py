...
class GithubService(BaseGitService):
    ...
    def get_project(
        ...
        return GithubProject(repo=repo, namespace=namespace, service=self, read_only=self.read_only,  **kwargs)
...
class GithubProject(BaseGitProject):
    ...
    @readonly(return_function=GitProjectReadOnly.pr_comment, text="Create Comment to PR")
    def pr_comment(
        self,
        pr_id: int,
        body: str,
